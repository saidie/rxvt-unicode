...
source=("$pkgname-$pkgver.tar.bz2::http://dist.schmorp.de/rxvt-unicode/$pkgname-$pkgver.tar.bz2"
        ...
        'signing-key.pub'
        'perl-5.38.patch'
        '417b540d6dba67d440e3617bc2cf6d7cea1ed968.diff'
        'urxvt.desktop'
        'urxvtc.desktop'
...
sha256sums=('aaa13fcbc149fe0f3f391f933279580f74a96fd312d6ed06b8ff03c2d46672e8'
            ...
            '8dafbe510f80c36be5c91777991b6b906ff2f9364462d990270bd2909b395b46'
...
sha512sums=('4d14ecbbb62de1b1c717277f5aae5cfb536e11392f2d4b82c884c1713f437fce8e9dd69a328fa353a55d068d8ee4121a31900f45191acec172d5dc76652b6255'
            ...
            'af9e517b3bd2197982c5d8b19348f3a4eb25322f5a9c1a88a575d11fb7f2335cc1b201db000feacb68020c4c9f9060971a535133f3ec4b0a0089fd422797d717'
...
prepare() {
  ...
  patch -d $pkgname-$pkgver -p1 < 417b540d6dba67d440e3617bc2cf6d7cea1ed968.diff
}
